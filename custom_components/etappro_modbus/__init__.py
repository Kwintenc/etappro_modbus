...
class AlfenModbusHub:
    ...
    def read_modbus_data_station(self):
        status_data = self.read_holding_registers(self._address,1100,4)
    ...
    def read_modbus_data_socket(self,socket):
        ...
        if(socket == 1):
            voltage_data = self.read_holding_registers(socket,306,6)
            ...
            current_data = self.read_holding_registers(socket,320,8)
            ...
            power_data = self.read_holding_registers(socket,338,8)
            ...
            energy_data = self.read_holding_registers(socket,374,4)
            ...
            status_data = self.read_holding_registers(socket,1200,12)
            if status_data.isError():
            ...
            extra_status_data = self.read_holding_registers(socket,1214,2)
    ...
    def read_modbus_data_product(self):
        identification_data = self.read_holding_registers(self._address, 100, 40)
        ...
        more_identification_data = self.read_holding_registers(self._address, 157, 22)
